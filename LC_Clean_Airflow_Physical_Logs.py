...
airflow trigger_dag --conf '{"maxLogAgeInDays":5}' airflow-log-cleanup
...
default_args = {
    ...
    'start_date': datetime(2018, 3, 20, 12, 10),
    'retries': 1,
    'retry_delay': timedelta(minutes=1)
}

dag = DAG(DAG_ID, default_args=default_args, schedule_interval='30 1 * * *',catchup=False)
